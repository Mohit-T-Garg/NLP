...
def run_evaluation(model_path, data_path):
    ...
    test_labels = [sample['langid'] for sample in loaded_data]
    ...
    print("Micro F1 Score:", compute_micro_f1_score(test_labels, predicted_test_labels))
    print("Macro F1 Score:", compute_macro_f1_score(test_labels, predicted_test_labels))
...
if __name__ == "__main__":
    ...
    run_evaluation(args.model, args.test_data)